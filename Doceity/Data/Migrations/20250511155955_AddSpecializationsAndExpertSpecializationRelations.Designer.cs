...
namespace Doceity.Data.Migrations
{
    ...
    [Migration("20250511155955_AddSpecializationsAndExpertSpecializationRelations")]
    partial class AddSpecializationsAndExpertSpecializationRelations
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Doceity.Models.Availability", b =>
                {
                    ...
                    b.HasIndex("ExpertUserId", "AvailableDate");
            ...
            modelBuilder.Entity("Doceity.Models.ConsultationRequest", b =>
                {
                    ...
                    b.Property<int?>("OriginalAvailabilityId")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("VideoRoomIdentifier")
                        .HasMaxLength(256)
                        .HasColumnType("nvarchar(256)");
                    ...
                    b.HasIndex("OriginalAvailabilityId");
            ...
            modelBuilder.Entity("Doceity.Models.CourseEnrollment", b =>
                {
            ...
            modelBuilder.Entity("Doceity.Models.ExpertSpecialization", b =>
                {
                    ...
                    b.HasKey("ApplicationUserId", "SpecializationId");

                    b.HasIndex("SpecializationId");

                    b.ToTable("ExpertSpecializations");
                });

            modelBuilder.Entity("Doceity.Models.Specialization", b =>
                {
                    b.Property<int>("SpecializationId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Doceity.Models.ConsultationRequest", b =>
                {
                    ...
                    b.HasOne("Doceity.Models.Availability", "OriginalAvailabilitySlot")
                        .WithMany()
                        .HasForeignKey("OriginalAvailabilityId")
                        .OnDelete(DeleteBehavior.Restrict);
                    ...
                    b.Navigation("OriginalAvailabilitySlot");
            ...
            modelBuilder.Entity("Doceity.Models.CourseEnrollment", b =>
                {
                    b.HasOne("Doceity.Models.Course", "Course")
                        .WithMany("Enrollments")
                        .HasForeignKey("CourseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Doceity.Models.ApplicationUser", "User")
            ...
            modelBuilder.Entity("Doceity.Models.ExpertSpecialization", b =>
                {
                    ...
                    b.HasOne("Doceity.Models.Specialization", "Specialization")
                        .WithMany("ExpertSpecializations")
